    ...
    return (
        <section id="contact" className="bg-gray-200 dark:bg-gray-800 py-10 md:py-20">
            <div className="max-w-7xl mx-auto px-4 text-center">
                ...
                <p className="mb-6">
                    Preencha o formulário abaixo ou envie um email para <a href="mailto:antoniJuevan@gmail.com" className="text-blue-600">antoniojuevan@gmail.com</a> ou ligue para <strong>(21) 96533-7473</strong>.
                </p>
                <div className="flex justify-center items-center gap-8 mb-6">
                    <a href="https://www.linkedin.com/in/ajuevan/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">
                    ...
                    <a href="https://github.com/Juevan" target="_blank" rel="noopener noreferrer" className="text-gray-800 hover:text-gray-600 dark:text-gray-100 dark:hover:text-gray-300">
                        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                ...
                <form className="max-w-xl mx-auto bg-white dark:bg-gray-700 rounded shadow p-6">
                    <div className="mb-4 text-left">
                        ...
                        <input
                            ...
                            className={`w-full bg-white dark:bg-gray-600 text-gray-900 dark:text-gray-100 border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:placeholder-gray-300 ${errors.nome ? "border-red-500" : "border-gray-300 dark:border-gray-600"}`}
                    ...
                    <div className="mb-4 text-left">
                        ...
                        <input
                            ...
                            className={`w-full bg-white dark:bg-gray-600 text-gray-900 dark:text-gray-100 border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:placeholder-gray-300 ${errors.email ? "border-red-500" : "border-gray-300 dark:border-gray-600"}`}
                            placeholder="seuemail@exemplo.com"
                        />
                        {errors.email && <p className="text-red-500 text-sm mt-1">{errors.email}</p>}
                    </div>
                    <div className="mb-4 text-left">
                        <label htmlFor="mensagem" className="block text-sm font-bold mb-2">Mensagem</label>
                        <textarea
                            id="mensagem"
                            rows={5}
                            value={mensagem}
                            onChange={e => setMensagem(e.target.value)}
                            className={`w-full bg-white dark:bg-gray-600 text-gray-900 dark:text-gray-100 border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:placeholder-gray-300 ${errors.mensagem ? "border-red-500" : "border-gray-300 dark:border-gray-600"}`}
